...
const IMAGE_DIR = 'docs/auto part workflow/Parts/Winni Parts/Helper/Downloaded_Images'
...
async function main() {
  ...
  const csvPath = 'docs/auto part workflow/Clean Data for import/Clean Uploaded images/MISSING_IMAGES.csv'
  ...
  // Save report
  const reportPath = 'docs/auto part workflow/Clean Data for import/Clean Uploaded images/MISSING_IMAGES_UPLOAD_REPORT.json'
