...
const styles = {
  info: {
    ...
    class:
      "my-6 flex gap-4 p-4 bg-blue-50 border-l-4 border-blue-500 rounded-r-xl",
  },
  warning: {
    ...
    class:
      "my-6 flex gap-4 p-4 bg-orange-50 border-l-4 border-orange-500 rounded-r-xl",
  },
  success: {
    ...
    class:
      "my-6 flex gap-4 p-4 bg-green-50 border-l-4 border-green-500 rounded-r-xl",
  },
  tip: {
    ...
    class:
      "my-6 flex gap-4 p-4 bg-purple-50 border-l-4 border-purple-500 rounded-r-xl",
  },
};
...
export const Callout = Node.create({
  ...
  renderHTML({ HTMLAttributes }: { HTMLAttributes: Record<string, string> }) {
    ...
    return [
      ...
      [
        "div",
        { class: "flex-shrink-0 mt-1 select-none font-bold" },
        type.toUpperCase(),
      ],
      ["div", { class: "flex-1" }, 0],
    ];
