        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <Link
                href="/ai"
                className="text-sm font-bold text-blue-600 dark:text-blue-400 hover:text-primary transition-colors relative group flex items-center gap-1"
              >
          ...
          <div className="flex items-center gap-3">
            ...
            {userRole ? (
              ...
              <Button
                size="sm"
                className="hidden md:flex shadow-md hover:shadow-lg transition-all"
