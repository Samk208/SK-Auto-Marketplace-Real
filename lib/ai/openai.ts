      ...
      messages: [
        {
          role: "system",
          content:
            "You are an expert automotive inspector. Respond only with valid JSON.",
        },
      ...
      messages: [
        {
          role: "system",
          content:
            "You are an expert car listing copywriter. Respond only with valid JSON.",
        },
        { role: "user", content: prompt },
      ],
      temperature: 0.7,
      ...
      messages: [
        {
          role: "system",
          content:
            "You are a professional translator. Respond only with valid JSON.",
        },
        { role: "user", content: prompt },
      ],
      temperature: 0.3,
